...
// source: core/api/monitor/v1/monitor.proto
...
public final class MonitorOuterClass {
  ...
  public  static final class GetStateRequest extends
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          google.keytransparency.monitor.v1.MonitorOuterClass.GetStateRequest, Builder> implements
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new google.keytransparency.monitor.v1.MonitorOuterClass.GetStateRequest();
        }
        case NEW_BUILDER: {
          return new Builder();
        }
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<google.keytransparency.monitor.v1.MonitorOuterClass.GetStateRequest> parser = PARSER;
          if (parser == null) {
            synchronized (google.keytransparency.monitor.v1.MonitorOuterClass.GetStateRequest.class) {
              parser = PARSER;
              if (parser == null) {
                parser =
                    new DefaultInstanceBasedParser<google.keytransparency.monitor.v1.MonitorOuterClass.GetStateRequest>(
                        DEFAULT_INSTANCE);
                PARSER = parser;
              }
            }
  ...
  public interface StateOrBuilder extends
     ...
     * @return The smr.
     */
    google.trillian.proto.SignedMapRoot getSmr();
  ...
  public  static final class State extends
    ...
    private google.trillian.proto.SignedMapRoot smr_;
    /**
     * <pre>
     * smr contains the map root for the sparse Merkle Tree signed with the
     * monitor's key on success. If the checks were not successful the
     ...
     */
    @java.lang.Override
    public google.trillian.proto.SignedMapRoot getSmr() {
      return smr_ == null ? google.trillian.proto.SignedMapRoot.getDefaultInstance() : smr_;
    }
    /**
     * <pre>
     * smr contains the map root for the sparse Merkle Tree signed with the
     ...
     * <code>.trillian.SignedMapRoot smr = 1;</code>
     */
    private void setSmr(google.trillian.proto.SignedMapRoot value) {
      value.getClass();
  smr_ = value;
    ...
    private void mergeSmr(google.trillian.proto.SignedMapRoot value) {
      value.getClass();
  if (smr_ != null &&
          smr_ != google.trillian.proto.SignedMapRoot.getDefaultInstance()) {
        smr_ =
          google.trillian.proto.SignedMapRoot.newBuilder(smr_).mergeFrom(value).buildPartial();
      } else {
        smr_ = value;
      }
  ...
  ensureErrorsIsMutable();
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          google.keytransparency.monitor.v1.MonitorOuterClass.State, Builder> implements
       ...
       * <code>.trillian.SignedMapRoot smr = 1;</code>
       */
      public Builder setSmr(google.trillian.proto.SignedMapRoot value) {
        copyOnWrite();
       ...
       * <code>.trillian.SignedMapRoot smr = 1;</code>
       */
      public Builder mergeSmr(google.trillian.proto.SignedMapRoot value) {
        copyOnWrite();
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new google.keytransparency.monitor.v1.MonitorOuterClass.State();
        }
        case NEW_BUILDER: {
          return new Builder();
        }
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<google.keytransparency.monitor.v1.MonitorOuterClass.State> parser = PARSER;
          if (parser == null) {
            synchronized (google.keytransparency.monitor.v1.MonitorOuterClass.State.class) {
              parser = PARSER;
              if (parser == null) {
                parser =
                    new DefaultInstanceBasedParser<google.keytransparency.monitor.v1.MonitorOuterClass.State>(
                        DEFAULT_INSTANCE);
                PARSER = parser;
              }
            }
