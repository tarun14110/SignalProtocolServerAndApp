...
// source: core/api/v1/frontend.proto
  ...
  public  static final class QueueKeyUpdateRequest extends
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          google.keytransparency.v1.Frontend.QueueKeyUpdateRequest, Builder> implements
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new google.keytransparency.v1.Frontend.QueueKeyUpdateRequest();
        }
        case NEW_BUILDER: {
          return new Builder();
        }
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<google.keytransparency.v1.Frontend.QueueKeyUpdateRequest> parser = PARSER;
          if (parser == null) {
            synchronized (google.keytransparency.v1.Frontend.QueueKeyUpdateRequest.class) {
              parser = PARSER;
              if (parser == null) {
                parser =
                    new DefaultInstanceBasedParser<google.keytransparency.v1.Frontend.QueueKeyUpdateRequest>(
                        DEFAULT_INSTANCE);
                PARSER = parser;
              }
            }
