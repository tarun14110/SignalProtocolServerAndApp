...
public class IdentityUtil {
  ...
  public static void saveIdentity(Context context, String number, IdentityKey identityKey) {
    synchronized (SESSION_LOCK) {
      ...
      Log.i("ISRL_TAG", "savvve idee");
      if (identityKeyStore.saveIdentity(address, identityKey)) {
        Log.i("ISRL_TAG", "savvvedd idee");
        if (sessionStore.containsSession(address)) {
          Log.i("ISRL_TAG", "savvveddoo idee");
  ...
  public static void processVerifiedMessage(Context context, VerifiedMessage verifiedMessage) {
    synchronized (SESSION_LOCK) {
      ...
      Log.i("ISRL_TAG", "Processing verified message (delete me later, what am I used for?  util.IdentityUtil.java)");
      ...
      {
        Log.i("ISRL_TAG", "Verified and identity record present (delete me later, what am I used for? util.IdentityUtil.java)");
      ...
      {
        Log.i("ISRL_TAG", "Verified but identity record not present (delete me later util.IdentityUtil.java)");
