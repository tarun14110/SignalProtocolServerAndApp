...
# <netstat -pant> outputs the info and the python finds the process id from the output and kills the process.

echo "Deleting old processes that use port 8080, don't worry if this throws an index error. (No processes to kill)"
