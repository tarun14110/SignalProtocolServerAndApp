...
public class AccountController {
      ...
      throws RateLimitExceededException
  {
    try {
      ...
      // BYU ISRL.
      // "+19999999999".equals(number)
      if (true) {
        // tired of typing verification number!
      } else if (!storedVerificationCode.isPresent() || !storedVerificationCode.get().isValid(verificationCode)) {
