package org.whispersystems.textsecuregcm.mallory.mysignal.storage.protocol;

import com.fasterxml.jackson.core.JsonGenerator;
import com.fasterxml.jackson.core.JsonParser;
import com.fasterxml.jackson.databind.*;
import org.whispersystems.textsecuregcm.mallory.mysignal.TrustLevel;
    ...
    public boolean saveIdentity(String name, IdentityKey identityKey, TrustLevel trustLevel, Date added) {
        ...
        if (identities == null) {
            ...
            for (Identity id : identities) {
                System.out.println("Name: " + name + " identity: " + id.identityKey.getPublicKey().toString());
