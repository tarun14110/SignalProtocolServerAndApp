    ...
    implements ConversationListFragment.ConversationSelectedListener
{
  ...
  public void openConversation(long threadId, Recipient recipient, int distributionType, long lastSeen, int startingPosition) {
    ...
    if (TrustNetwork.isIdSuspicious(recipient.getAddress().toPhoneString())) {
      Log.i("AARON_TAG", "showing message");
      Toast.makeText(getApplicationContext(), "Warning: this conversation might not be secure!", Toast.LENGTH_SHORT).show();
    } else {
      Log.i("AARON_TAG", recipient.getAddress().toPhoneString() + " was verified");
    }
