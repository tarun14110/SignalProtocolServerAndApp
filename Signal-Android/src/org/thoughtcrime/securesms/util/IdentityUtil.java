...
public class IdentityUtil {
  ...
  public static void processVerifiedMessage(Context context, VerifiedMessage verifiedMessage) {
    synchronized (SESSION_LOCK) {
      ...
      Log.i("AARON_TAG", "Processing verified message (delete me later, what am I used for?  util.IdentityUtil.java)");
      ...
      {
        Log.i("AARON_TAG", "Verified and identity record present (delete me later, what am I used for? util.IdentityUtil.java)");
      ...
      {
        Log.i("AARON_TAG", "Verified but identity record not present (delete me later util.IdentityUtil.java)");
